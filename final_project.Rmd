...
>>>>>>> 950524d97b169b750721221402ea4e5a93e8ec45
```
...
stargazer(data=fullOLS.lm2, type="text", title = "Summary Statistics for Model Based on Selected Variables")
=======
...
<<<<<<< HEAD
trimmedOLS.lm = lm(logPrice~host_response_time+host_is_superhost+neighbourhood_cleansed+bedrooms+review_scores_rating+reviews_per_month+monuments_nn3, data=st_drop_geometry(full_listings.sf) %>% drop_na())
...
```{r}
<<<<<<< HEAD
smarter_model = lm(logPrice ~ log10(lagPrice)+host_response_time+host_is_superhost+neighbourhood_cleansed+bedrooms+review_scores_rating+reviews_per_month+monuments_nn3, data=st_drop_geometry(drop_na(full_listings.sf)))

stargazer(data=smarter_model, type="text", title = "Summary Statistics for Model Using Lag Price")
```

```{r}
smarter_model2 = lm(logPrice ~., data=st_drop_geometry(drop_na(select(full_listings.sf,-price))))

stargazer(data=fullOLS.lm2, type="text", title = "Summary Statistics for Model Using log(Price)")
=======
