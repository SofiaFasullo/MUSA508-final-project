...
summary_smarter = summary(smarter_model)
...
summary_smarterSink = summary(smarter_model2)
...
```{r}
#table
models = c("Kitchen Sink Model", "Selective Model", "Spatial Kitchen Sink Model", "Spatial Selective Model")
rsquared = c(summary_fullOLS$r.squared, summary_trimmedOLS$r.squared, summary_smarterSink$r.squared, summary_smarter$r.squared)

diagnostics_table = data.frame("Model"=models, "R Squared Value" = rsquared)
